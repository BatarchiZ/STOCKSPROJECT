...
plt.savefig('Static/graphs/ESR_plot.jpeg')
figfile = io.BytesIO()
...
plt.savefig('Static/graphs/PER_plot.jpeg')
figfile = io.BytesIO()
plt.savefig(figfile, format='jpeg')
plt.clf()
...
plt.savefig('Static/graphs/PSR_plot.jpeg')
figfile = io.BytesIO()
plt.savefig(figfile, format='jpeg')
plt.clf()
...
plt.savefig('Static/graphs/BV_plot.jpeg')
figfile = io.BytesIO()
plt.savefig(figfile, format='jpeg')
plt.clf()
# plt.show()
...
plt.savefig('Static/graphs/PSR_PBR_plots.jpeg')
figfile = io.BytesIO()
plt.savefig(figfile, format='jpeg')
plt.clf()
...
plt.savefig('Static/graphs/PER_ESR_plots.jpeg')
figfile = io.BytesIO()
plt.savefig(figfile, format='jpeg')
plt.clf()
# Task 3
...
plt.savefig('Static/graphs/Task3_1_hist.jpeg')
figfile = io.BytesIO()
plt.savefig(figfile, format='jpeg')
plt.clf()
...
plt.savefig('Static/graphs/Task3_1_hist_sect.jpeg')
figfile = io.BytesIO()
plt.savefig(figfile, format='jpeg')
plt.clf()
...
plt.savefig('Static/graphs/Task3_1_hist_BV_sect.jpeg')
figfile = io.BytesIO()
plt.savefig(figfile, format='jpeg')
plt.clf()
...
plt.savefig('Static/graphs/Task3_cluster.jpeg')
figfile = io.BytesIO()
plt.savefig(figfile, format='jpeg')
plt.clf()
