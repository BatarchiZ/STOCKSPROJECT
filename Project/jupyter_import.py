...
plt.savefig('Project/static/graphs/ESR_plot.jpeg')
figfile = io.BytesIO()
...
plt.savefig('Project/static/graphs/PER_plot.jpeg')
figfile = io.BytesIO()
plt.savefig(figfile, format='jpeg')
plt.clf()
...
plt.savefig('Project/static/graphs/PSR_plot.jpeg')
figfile = io.BytesIO()
plt.savefig(figfile, format='jpeg')
plt.clf()
...
plt.savefig('Project/static/graphs/BV_plot.jpeg')
figfile = io.BytesIO()
plt.savefig(figfile, format='jpeg')
plt.clf()
# plt.show()
...
plt.savefig('Project/static/graphs/PSR_PBR_plots.jpeg')
figfile = io.BytesIO()
plt.savefig(figfile, format='jpeg')
plt.clf()
...
plt.savefig('Project/static/graphs/PER_ESR_plots.jpeg')
figfile = io.BytesIO()
plt.savefig(figfile, format='jpeg')
plt.clf()
# Task 3
...
#
# plt.savefig('Project/static/Task3_0_cat.jpeg')
# figfile = io.BytesIO()
# plt.savefig(figfile, format='jpeg')
# plt.clf()
#
...
# plt.savefig('Project/static/Task3_0_cat_sect.jpeg')
# figfile = io.BytesIO()
# plt.savefig(figfile, format='jpeg')
# plt.clf()
...
plt.savefig('Project/static/graphs/Task3_1_hist.jpeg')
figfile = io.BytesIO()
plt.savefig(figfile, format='jpeg')
plt.clf()
...
plt.savefig('Project/static/graphs/Task3_1_hist_sect.jpeg')
figfile = io.BytesIO()
plt.savefig(figfile, format='jpeg')
plt.clf()
...
plt.savefig('Project/static/graphs/Task3_1_hist_BV_sect.jpeg')
figfile = io.BytesIO()
plt.savefig(figfile, format='jpeg')
plt.clf()
...
plt.savefig('Project/static/graphs/Task3_2_pie1.jpeg')
figfile = io.BytesIO()
plt.savefig(figfile, format='jpeg')
plt.clf()

dq3.plot.pie(y='ValueCounts', figsize=(10, 10)).set_title('S&P500 Number of Companies Pie Chart (by sector)')
plt.savefig('Project/static/graphs/Task3_2_pie2.jpeg')
figfile = io.BytesIO()
plt.savefig(figfile, format='jpeg')
plt.clf()
...
plt.savefig('Project/static/graphs/Task3_cluster.jpeg')
figfile = io.BytesIO()
plt.savefig(figfile, format='jpeg')
plt.clf()
